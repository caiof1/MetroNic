...
<div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <ul class="nav navbar-nav pull-right">
        ...
        <ul class="dropdown-menu extended notification">
            <li>
            <p>Você tem 6 novas notificações</p>
            </li>
            <li>
            ...
            <li class="external">
            <a href="#"
                >Ver todas as notificações <i class="m-icon-swapright"></i
            ></a>
            </li>
        </ul>
        </li>
        ...
        <ul class="dropdown-menu extended inbox">
            <li>
            <p>Você tem 5 novas mensagens</p>
            </li>
            <li>
            <ul class="dropdown-menu-list scroller" style="height: 250px">
                <li>
                ...
                <a href="inbox.html?a=view">
                    ...
                    elit. Eius quo magni praesentium quia nostrum natus, aut
                    rerum odit tenetur dolores.
                    </span>
                </a>
                </li>
                <li>
                ...
                <a href="inbox.html?a=view">
                    ...
                    <span class="message">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Laboriosam quam facilis debitis.
                    </span>
                </a>
                </li>
                <li>
            ...
            <li class="external">
            <a href="inbox.html"
                >Ver todas as mensagens <i class="m-icon-swapright"></i
            ></a>
            </li>
        </ul>
        </li>
        ...
        <ul class="dropdown-menu extended tasks">
            <li>
            <p>Você tem 5 tarefas pendentes</p>
            </li>
            <li>
            <ul class="dropdown-menu-list scroller" style="height: 250px">
                <li>
                <a href="#">
                    <span class="task">
                    <span class="desc"> Nova release v1.2 </span>
                ...
                <a href="#">
                    ...
                    <span
                        ...
                        aria-valuemax="100"
                    >
                        <span class="sr-only"> 58% Completado </span>
                    </span>
                    </span>
                </a>
                </li>
                ...
                <a href="#">
                    ...
                    <span
                        ...
                        aria-valuemax="100"
                    >
                        <span class="sr-only"> 18% Completado </span>
                    </span>
                    </span>
                </a>
                </li>
            ...
            <li class="external">
            <a href="#"
                >Ver todas as tarefas <i class="m-icon-swapright"></i
            ></a>
            </li>
        </ul>
        </li>
        ...
        >
            ...
            <span class="username"> Estágiário </span>
